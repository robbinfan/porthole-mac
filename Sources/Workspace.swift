...
extension Workspace {
    ...
    private func sessionPanelSnapshot(panelId: UUID, includeScrollback: Bool) -> SessionPanelSnapshot? {
        ...
        case .diff:
            ...
            browserSnapshot = nil
            markdownSnapshot = nil
            diffSnapshot = SessionDiffPanelSnapshot(filePath: diffPanel.filePath)
        }
    ...
    private func createPanel(from snapshot: SessionPanelSnapshot, inPane paneId: PaneID) -> UUID? {
        ...
        case .diff:
            guard let filePath = snapshot.diff?.filePath,
...
final class Workspace: Identifiable, ObservableObject {
    ...
    func newDiffSplit(
        ...
        let diffPanel = DiffPanel(workspaceId: id, filePath: filePath)
